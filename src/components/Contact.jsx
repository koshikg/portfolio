...
export default function Contact() {
  return (
    <section id="contact" className="section bg-light dark:bg-dark-light">
      <div className="container mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-dark dark:text-text-primary mb-4">Get In Touch</h2>
        <p className="text-gray-700 dark:text-text-secondary max-w-2xl mx-auto mb-8">
          ...
          <div className="flex space-x-6 mt-8">
            {Object.entries(config.socials).map(([platform, url]) => (
              <a 
                ...
                className="text-gray-600 dark:text-text-secondary hover:text-primary transition-colors duration-300"
                aria-label={platform}
              >
                {platform === 'linkedin' && (
